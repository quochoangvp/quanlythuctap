            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="<?php echo api_url('user/add'); ?>" method="post" accept-charset="utf-8" role="form">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-6 col-lg-4">
                                        <input type="text" name="username" class="form-control" value="" required="required" placeholder="Nhập tên người dùng">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-6 col-lg-4">
                                        <input type="text" name="name" class="form-control" value="" required="required" placeholder="Nhập họ tên">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-6 col-lg-4">
                                        <input type="email" name="email" class="form-control" value="" required="required" placeholder="Nhập email">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-6 col-lg-4">
                                        <select name="type" class="form-control" required="required">
                                            ...
                                            <option value="2">Giảng viên phụ trách</option>
                                            <option value="3">Công ty thực tập</option>
                                            <option value="4">Giáo vụ</option>
                                            <option value="6">Bộ phận phụ trách</option>
