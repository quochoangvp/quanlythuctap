            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="<?php echo api_url('practice_report/add'); ?>" method="post" accept-charset="utf-8" role="form" enctype="multipart/form-data">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-6 col-lg-4">
                                        <input type="text" name="pr_title" class="form-control" value="" required="required" placeholder="Nhập tiêu đề">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
